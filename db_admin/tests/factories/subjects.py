...
from db_admin.tests.factories.themes import ThemeFactory
...
class CommentFactory(DjangoModelFactory):
    ...
    parent_comment = LazyFunction(
        lambda: CommentFactory(previous_comment=None, parent_comment=None)
    )
    previous_comment = LazyFunction(
        lambda: CommentFactory(previous_comment=None, parent_comment=None)
    )
